...
##   4. Summarize the total PM2.5 emission data of Baltimore City by year
...
# summarize total PM2.5 emission in Baltimore City, Maryland by year
aggrData <- aggregate(Emissions ~ year, FUN=sum, data=subNEI)

## Plot PM2.5 emission trend
png("plot2.png", bg="lightgrey") # PNG graph device - default 480x480 pxs
# plot total PM2.5 emission in Baltimore City, Maryland 
plot(aggrData$year, aggrData$Emissions, type = "b", xaxp=c(1999, 2008,3), 
     main="Annual Total PM2.5 Emission in\n Baltimore City, Maryland", 
